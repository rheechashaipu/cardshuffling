...
2) Open a terminal and enter that directory

3) Assuming you have git, enter 'git clone https://github.com/rheechashaipu/cardshuffling.git'

4) Change directory to the cardshuffling folder. You'll have to cd twice to get to it. I know, I'm sorry for my poor folder management here.

5) Type, 'npm install' followed by 'npm start'
